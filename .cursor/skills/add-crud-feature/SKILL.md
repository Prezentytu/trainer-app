...
Dodaje nowy zasób w Trainer App według sprawdzonego wzorca modułu referencyjnego **`Clients`**. Kopiuj wzorzec zamiast wymyślać architekturę. Zawsze najpierw przeczytaj root `AGENTS.md`, `backend/AGENTS.md`, `web/AGENTS.md`.
...
6. Usuń `backend/trainer.db` i zrestartuj backend, by schemat się przebudował.
...
### Test i walidacja
11. `backend.Tests/` — dodaj test integracyjny na wzór `ClientsEndpointsTests` (CRUD happy path + 404).
